...
/*   Updated: 2022/01/28 16:02:04 by brattles         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Bureaucrat::signForm(Form &form) {
	if (form.getIsSigned() == 1) {
		std::cout << name << " signs " << form.getFormName() << std::endl;
	} else {
		std::cout << name << " cannot sign " << form.getFormName() << " because ";
		if (grade > form.getExecuteGrade() && grade > form.getRequiredGrade())
			std::cout << "all grade is low.";
		else if (grade > form.getExecuteGrade())
			std::cout << "execute grade is low.";
		else if (grade > form.getRequiredGrade())
...
void Bureaucrat::executeForm(Form const &form) {
	if (grade >= form.getExecuteGrade()) {
		...
		std::cout << name << " executes " << form.getFormName() << std::endl;
	}
}
